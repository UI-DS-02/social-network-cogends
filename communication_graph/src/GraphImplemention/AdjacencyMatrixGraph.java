...
//        }
    ...
    public int outDegree(Vertex<V> vertex) {
        ...
        int outgoing=0;
        for (Edge<E> edge:square[vertex1.getIndex()]){
            if (edge!=null)
                outgoing++;
        }
        return outgoing;
    ...
    public int inDegree(Vertex<V> vertex) {
        ...
        int incoming=0;
        for (int i=0 ; i<numOfVertices;i++){
            if (square[i][vertex1.getIndex()]!=null)
                incoming++;
        }
        return incoming;
    }
    public Iterable<Edge<E>> incomingEdges(Vertex<V> vertex) {
        ...
        for (int i=0 ; i<numOfVertices;i++){
            if (square[i][vertex1.getIndex()]!=null)
                edges.add(square[i][vertex1.getIndex()]);
        }
        return edges;
    }
    public Edge<E> getEdge(Vertex<V> u, Vertex<V> v) {
        ...
        return square[origin.getIndex()][des.getIndex()];
    }
    ...
    public Vertex<V>[] endVertices(Edge<E> inputEdge) {
        ...
        for (int i=0 ; i<numOfVertices;i++){
            for (int j=0 ; j<numOfVertices;j++){
                if (square[j][j]!=null){
                    if (square[j][j]==edge){
                        endPoint[0]=vertices[i];
                        endPoint[1]=vertices[j];
                    }
                }
            }
        }
    ...
    public void removeVertex(Vertex<V> v) {
        ...
        for (Edge<E> edge : outgoingEdges(vertex0))
            removeEdge(edge);
        for (Edge<E> edge : incomingEdges(vertex0))
            removeEdge(edge);
    }
